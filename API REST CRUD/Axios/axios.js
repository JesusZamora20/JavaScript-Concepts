    ...
    if(e.target === $form){
        ...
        if(!e.target.id.value){
            ...
            try {
                ...
                let res = await axios("http://localhost:5000/players", options);
                let json = await res.data();
                location.reload();
            } catch (err) {
            ...
            try {
                ...
                let res = await axios(`http://localhost:5000/players/${e.target.id.value}`, options);
    ...
    if(e.target.matches(".delete")){
        ...
        if(isDeleted){
            try {
                ...
                let res = await axios(`http://localhost:5000/players/${e.target.dataset.id}`, options);
                let json = await res.data();
